<script setup lang="ts">
   import SingleCommentReply from './SingleCommentReply.vue';
</script>
<template>
    <div class="single__comment">
        ...
        <div class="single__comment__body">
            <div>
                ...
                <p class="comment">
                   Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti perspiciatis repellendus quos ratione exercitationem! Laboriosam in aperiam, voluptates quisquam nobis odio minus deleniti consectetur. Cum minus ex alias dolorum repudiandae!
                </p>
